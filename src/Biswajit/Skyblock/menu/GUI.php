  ...
  public function SettingsMenu(Player $player): void
  {
    ...
    $menu->setListener(
      function (InvMenuTransaction $transaction) use ($menu) : InvMenuTransactionResult 
      {
        ...
        $grayGlass = VanillaBlocks::WOOL()->setColor(DyeColor::GRAY());
        $redGlass = VanillaBlocks::WOOL()->setColor(DyeColor::RED());
        $itemInName = $transaction->getIn()->getCustomName();
        $itemOutName = $transaction->getOut()->getCustomName();
        
        
        if($transaction->getAction()->getSlot() === 10)
        {
          ...
          if($maxVisitors < 10)
          {
            ...
            {
              $inv->setItem(19, GlobalItemDataHandlers::getDeserializer()->deserializeStack(GlobalItemDataHandlers::getUpgrader()->upgradeItemTypeDataInt(397, 3, 1, null))->setCustomName("§r §aMax Visitors§7: §r\n§r §e".$maxVisitors + 1));
        ...
        }elseif($transaction->getAction()->getSlot() === 12)
        {
        ...
        }elseif($transaction->getAction()->getSlot() === 28)
        {
          $maxVisitors = $this->api->getMaxVisitors($player);
          if($maxVisitors > 1)
          {
        ...
        }elseif($transaction->getAction()->getSlot() === 14)
        {
          ...
          if($this->api->setCanDropItems($player, $updateCanDrop))
          {
            if($updateCanDrop)
            {
              ...
              $inv->setItem(14, GlobalItemDataHandlers::getDeserializer()->deserializeStack(GlobalItemDataHandlers::getUpgrader()->upgradeItemTypeDataInt(288, 0, 1, null))->setCustomName("§r §aDrop/Pickup Items§7: §aEnabled §r\n§r §7Whether Visitors Can Drop/Pickup Item §r"));
            }else{
              $player->sendMessage("§aVisiotrs dropping/picking items disabled");
              $inv->setItem(14, GlobalItemDataHandlers::getDeserializer()->deserializeStack(GlobalItemDataHandlers::getUpgrader()->upgradeItemTypeDataInt(288, 0, 1, null))->setCustomName("§r §aDrop/Pickup Items§7: §cDisabled §r\n§r §7Whether Visitors Can Drop/Pickup Item §r"));
            }
          }else{
            $player->sendMessage("§cError can't Update Droping Items");
          }
        }elseif($transaction->getAction()->getSlot() === 32)
        {
        ...
        }elseif($transaction->getAction()->getSlot() === 30)
        {
          if($this->api->getCoOpRole($player) === "Owner" || $this->api->getCoOpRole($player) === "Co-Owner")
          {
    ...
    $inv->setItem(10, GlobalItemDataHandlers::getDeserializer()->deserializeStack(GlobalItemDataHandlers::getUpgrader()->upgradeItemTypeDataInt(159, 13, 1, null))->setCustomName("§r §a+ §r"));
    $inv->setItem(11, VanillaBlocks::GLASS_PANE()->asItem()->setCustomName("§r §7 §r"));
    $inv->setItem(12, GlobalItemDataHandlers::getDeserializer()->deserializeStack(GlobalItemDataHandlers::getUpgrader()->upgradeItemTypeDataInt(2, 0, 1, null))->setCustomName("§r §aSet Spawn §r\n§r §7Sets Island Spawn Point §r"));
    $inv->setItem(13, VanillaBlocks::GLASS_PANE()->asItem()->setCustomName("§r §7 §r"));
    $inv->setItem(14, GlobalItemDataHandlers::getDeserializer()->deserializeStack(GlobalItemDataHandlers::getUpgrader()->upgradeItemTypeDataInt(288, 0, 1, null))->setCustomName("§r §aDrop/Pickup Items§7: $canDrop §r\n§r §7Whether Visitors Can Drop/Pickup Item §r"));
    ...
    $inv->setItem(28, GlobalItemDataHandlers::getDeserializer()->deserializeStack(GlobalItemDataHandlers::getUpgrader()->upgradeItemTypeDataInt(159, 14, 1, null))->setCustomName("§r §c- §r"));
    $inv->setItem(29, VanillaBlocks::GLASS_PANE()->asItem()->setCustomName("§r §7 §r"));
    $inv->setItem(30, GlobalItemDataHandlers::getDeserializer()->deserializeStack(GlobalItemDataHandlers::getUpgrader()->upgradeItemTypeDataInt(278, 0, 1, null))->setCustomName("§r §eManage Members §r"));
    $inv->setItem(31, VanillaBlocks::GLASS_PANE()->asItem()->setCustomName("§r §7 §r"));
    $inv->setItem(32, GlobalItemDataHandlers::getDeserializer()->deserializeStack(GlobalItemDataHandlers::getUpgrader()->upgradeItemTypeDataInt(397, 1, 1, null))->setCustomName("§r §eAdd Member §r"));
